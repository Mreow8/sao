...
urlpatterns = [
    ...
    path('schoife/', include('mainpage.zsao_urls.slife_url')),
    path('jolarship/', include('mainpage.zsao_urls.schol_url')),
    path('slbplacement/', include('mainpage.zsao_urls.job_url')),
    ...
    path('discipline/', include('mainpage.zsao_urls.disc_url')),
]
