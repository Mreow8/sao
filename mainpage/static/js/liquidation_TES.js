...
function updateReportHeader() {
    ...
    reportHeaderElement.textContent = `Fund Utilization Report of the TES/Administrative Support Cost (ASC) as of ${semester} ${academicYear}`;
}

function calculate() {
    const amount1 = parseFloat(document.getElementById('amount1').value) || 0;

    const amount1_0_05 = (amount1 * 0.01).toFixed(2);
