$(document).ready(function () {
  ...
  $("#searchButton").on("click", function (event) {
    ...
    $.ajax({
      url: "/main/search_ojt_assessment_request/",
      method: "POST",
        ...
        response.forEach(function (student) {
          ...
          if (student.status == "Accepted") {
            ...
            status_val = '<span class="accepted">Accepted</span>';
             ...
             // BUG FIX: Was showing "Pending" text for "Declined" status
  ...
  $(document).on("click", ".accept", function () {
    ...
    $.post({
      url: "/main/update_ojt_assessment/",
  ...
  $(document).on("click", ".showformButton", function () {
    ...
    $.post({
      url: "/main/get_ojt_assessment_data/",
  ...
  $(document).on("click", ".delete", function () {
    ...
    $.post({
      url: "/main/delete_ojt_assessment/",
      data: { OjtRequestID: OjtRequestID }, // BUG FIX: Was 'exitinterviewId'
      beforeSend: function (xhr, settings) {
        xhr.setRequestHeader("X-CSRFToken", csrftoken);
      },
      headers: { "X-CSRFToken": csrftoken },
