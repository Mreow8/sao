...
class Studentinfo(models.Model):
    ...
    sanction_completed = models.BooleanField(default=False, null=True, blank=True)
...
class GoodMoral(models.Model):
    case_profile = models.ForeignKey(CaseProfile, on_delete=models.SET_NULL, null=True)
    student = models.ForeignKey(Studentinfo, on_delete=models.SET_NULL, null=True)
    ...
    def __str__(self):
        return self.student.lastname if self.student else "No student assigned"
